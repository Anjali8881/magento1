...
class Ccc_Order_Adminhtml_Order_CartController extends Mage_Adminhtml_Controller_Action {
	...
	public function AddToCartAction() {
		...
		Mage::getSingleton('adminhtml/session')->addSuccess('Your Product is Added Successfully');
	...
	public function updateShippingAction() {
		...
		Mage::getSingleton('adminhtml/session')->addSuccess('Shipping Method Saved Successfully');
		$this->_redirect('*/adminhtml_order_cart/index', array('_current' => true));
	...
	public function updatePaymentAction() {
		...
		Mage::getSingleton('adminhtml/session')->addSuccess('Payment Method Saved Saved Successfully');
		$this->_redirect('*/adminhtml_order_cart/index', array('_current' => true));
	...
	public function changeQuantityAction() {
		...
		Mage::getSingleton('adminhtml/session')->addSuccess('Product Quantity Changed Successfully');
		$this->_redirect('*/adminhtml_order_cart/index', array('_current' => true));
	...
	public function placeOrderAction() {
		...
		if ($cartItems->count() <= 0) {
			Mage::getSingleton('adminhtml/session')->addError('Please Add At Least One Item In Cart');
			$this->_redirect('*/adminhtml_order_cart/index', array('_current' => true));
			return;
		}
		if (!$billingAddress) {
		...
		Mage::getSingleton('adminhtml/session')->addSuccess("Your Order Is Placed Successfully");
