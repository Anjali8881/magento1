...
class Ccc_Salesman_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const SCOPE_STORE                           = 0;
    ...
    public static function initLabels($storeId = null)
    {
        if (is_null(self::$_labels)) {
            ...
            $attributes = Mage::getResourceSingleton('salesmanattribute/salesmanattribute')->getAttributesByCode();
