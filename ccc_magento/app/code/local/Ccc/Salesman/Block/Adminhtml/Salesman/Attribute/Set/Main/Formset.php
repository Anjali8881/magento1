...
class Ccc_Salesman_Block_Adminhtml_Salesman_Attribute_Set_Main_Formset extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('set_name', array('legend'=> Mage::helper('salesman')->__('Edit Set Name')));
        $fieldset->addField('attribute_set_name', 'text', array(
            'label' => Mage::helper('salesman')->__('Name'),
            'note' => Mage::helper('salesman')->__('For internal use.'),
        ...
        if( !$this->getRequest()->getParam('id', false) ) {
            ...
            $fieldset->addField('skeleton_set', 'select', array(
                'label' => Mage::helper('salesman')->__('Based On'),
                'name' => 'skeleton_set',
                'required' => true,
